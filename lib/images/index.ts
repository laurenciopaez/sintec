// Image path constants for SINTECSA website
...
export const SERVICE_RBI2 = "sintec/img/service2/consecuencia.jpg";
export const SERVICE_FAILURE2 = "sintec/img/service2/FEA abrazaderas.png";
export const SERVICE_CORROSION2 = "sintec/img/service2/corrosion1.png";
export const SERVICE_INSPECTION2 = "sintec/img/service2/phasedarray1.png";
export const SERVICE_PROCEDURES2 = "sintec/img/service2/operacion1.jpeg";

// Client logos
export const CLIENT_1 = "sintec/img/logos/YPF_logo.png";
export const CLIENT_2 = "sintec/img/logos/PAE_logo.png";
export const CLIENT_3 = "sintec/img/logos/HOKCHI_logo.jpg";
export const CLIENT_4 = "sintec/img/logos/TERMAP_logo.png";
export const CLIENT_5 = "sintec/img/logos/TECPETROL_logo.jpg";
export const CLIENT_6 = "sintec/img/logos/OLDELVAL_logo.png";
export const CLIENT_7 = "sintec/img/logos/PLUSPETROL_logo.png";

// Team member photos
export const TEAM_MEMBER_1 = "";
export const TEAM_MEMBER_2 = "";
export const TEAM_MEMBER_3 = "";
export const TEAM_MEMBER_4 = "";

// Certification logos
export const CERT_API = "";
export const CERT_NACE = "";
export const CERT_ISO = "";
export const CERT_ASME = "";
