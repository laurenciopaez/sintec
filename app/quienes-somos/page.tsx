        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection variant="slideRight">
              ...
              <h2 className="text-4xl font-bold text-[#1d1d1f] mb-8">
                {content.story.title}
              </h2>
                    ...
                    {[
                      ...
                      <div key={index} className="flex gap-4">
                        <div className="flex flex-col items-center">
                          <div className="w-10 h-10 rounded-full bg-[#0066cc] flex items-center justify-center shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <AnimatedSection variant="slideUp" delay={0.1}>
              <div className="bg-white rounded-3xl p-8 border border-[#d2d2d7]/50 h-full">
                <div className="w-12 h-12 rounded-2xl bg-[#0066cc] flex items-center justify-center mb-6">
            ...
            <AnimatedSection variant="slideUp" delay={0.2}>
              <div className="bg-[#1d1d1f] rounded-3xl p-8 h-full">
                <div className="w-12 h-12 rounded-2xl bg-[#0066cc] flex items-center justify-center mb-6">
          ...
          >
            {VALUES.map((value) => (
              <StaggerItem key={value.title}>
                <div className="bg-white rounded-2xl p-6 border border-[#d2d2d7]/50 hover:border-[#0066cc]/30 hover:shadow-lg transition-all duration-300 h-full">
                  <div className="w-11 h-11 rounded-xl bg-[#0066cc]/10 flex items-center justify-center text-[#0066cc] mb-4">
                    {iconMap[value.icon]}
                  </div>
          ...
          >
            {content.whyUs.reasons.map((reason) => (
              <StaggerItem key={reason.title}>
                <div className="group p-6 rounded-2xl border border-[#d2d2d7]/50 hover:border-[#0066cc]/30 hover:bg-[#f5f5f7] transition-all duration-300 h-full">
                  <div className="w-10 h-10 rounded-xl bg-[#0066cc]/10 flex items-center justify-center text-[#0066cc] mb-4 group-hover:bg-[#0066cc] group-hover:text-white transition-all duration-300">
                    {iconMap[reason.icon]}
                  </div>
          ...
          >
            {content.certifications.items.map((cert) => (
              <StaggerItem key={cert}>
                <div className="bg-white/5 border border-white/10 rounded-xl px-5 py-4 hover:bg-white/10 hover:border-[#0066cc]/40 transition-all duration-200">
                  <div className="flex items-center gap-3">
                    <CheckCircle size={18} className="text-[#3399ff] shrink-0" />
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection variant="scaleIn">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/#contacto"
                className="inline-flex items-center justify-center gap-2 bg-[#0066cc] hover:bg-[#004499] text-white px-8 py-4 rounded-xl font-semibold text-base transition-all duration-200"
              >
                Contactar ahora
              </Link>
              <Link
                href="/soluciones"
                className="inline-flex items-center justify-center gap-2 border border-[#d2d2d7] hover:border-[#0066cc] text-[#1d1d1f] hover:text-[#0066cc] px-8 py-4 rounded-xl font-semibold text-base transition-all duration-200"
              >
