...
// ── Knowledge base ─────────────────────────────────────────────────────────────
const SYSTEM_PROMPT = `Eres el asistente virtual de SINTEC S.A., consultora argentina especializada en ingeniería de integridad industrial, con sede en Mar del Plata, Buenos Aires. Fundada en 2004. Web: sintecsa.com.ar.
...
- CUI (Corrosión Bajo Aislación): progresa oculta, rango crítico -4°C a 175°C. Detección: pulsed eddy current (PEC), radiografía computarizada, termografía infrarroja.
