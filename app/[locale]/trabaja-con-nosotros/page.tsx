...
import { JobApplicationForm } from "@/app/trabaja-con-nosotros/JobApplicationForm";
import * as esConstants from "@/lib/constants";
import * as enConstants from "@/lib/constants-en";

function getLocaleData(locale: string) {
  return locale === "en" ? enConstants.TRABAJA_CON_NOSOTROS : esConstants.TRABAJA_CON_NOSOTROS;
}
...
export default async function LocaleTrabajaConNosotrosPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
